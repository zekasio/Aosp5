    ...
    */
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            ...
            if (theme != null) {
                if (Build.VERSION.SDK_INT >= 23 && SearchView$$ExternalSyntheticApiModelOutline0.m$1(spinnerAdapter)) {
                    android.widget.ThemedSpinnerAdapter themedSpinnerAdapterM4m = SearchView$$ExternalSyntheticApiModelOutline0.m4m((Object) spinnerAdapter);
                    if (themedSpinnerAdapterM4m.getDropDownViewTheme() != theme) {
                        themedSpinnerAdapterM4m.setDropDownViewTheme(theme);
                        return;
                    }
                    return;
                }
