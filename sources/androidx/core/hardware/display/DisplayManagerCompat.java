...
public final class DisplayManagerCompat {
    ...
    public Display getDisplay(int i) {
        return Api17Impl.getDisplay((DisplayManager) this.mContext.getSystemService(TJAdUnitConstants.String.DISPLAY), i);
    }

    public Display[] getDisplays() {
        return Api17Impl.getDisplays((DisplayManager) this.mContext.getSystemService(TJAdUnitConstants.String.DISPLAY));
    }
