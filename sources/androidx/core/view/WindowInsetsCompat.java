    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        private static WindowInsets createWindowInsetsInstance() {
            if (!sConsumedFieldFetched) {
                try {
                    sConsumedField = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m145m().getDeclaredField("CONSUMED");
                } catch (ReflectiveOperationException e) {
            ...
            if (!sConstructorFetched) {
                try {
                    sConstructor = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m145m().getConstructor(Rect.class);
