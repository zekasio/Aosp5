...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return ViewCompat$$ExternalSyntheticApiModelOutline0.m114m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = ViewCompat$$ExternalSyntheticApiModelOutline0.m114m(Preconditions.checkNotNull(contentInfo));
        }
