...
public final class SizeFCompat {
    ...
    public SizeFCompat(float f, float f2) {
        this.mWidth = Preconditions.checkArgumentFinite(f, TJAdUnitConstants.String.WIDTH);
        this.mHeight = Preconditions.checkArgumentFinite(f2, TJAdUnitConstants.String.HEIGHT);
    }
