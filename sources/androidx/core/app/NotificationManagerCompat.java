...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelM = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(it.next());
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupM = PackageInfoCompat$$ExternalSyntheticApiModelOutline0.m((Object) it.next());
