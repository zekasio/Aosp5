...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m20m(it2.next())));
                }
            }
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && NotificationCompat$$ExternalSyntheticApiModelOutline0.m44m((Object) parcelable)) {
                return IconCompat.createFromIcon(NotificationCompat$$ExternalSyntheticApiModelOutline0.m25m((Object) parcelable));
            }
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m20m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m56clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            android.app.RemoteInput remoteInputM21m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m21m((Object) bundle.getParcelable(KEY_REMOTE_INPUT));
            String[] stringArray = bundle.getStringArray(KEY_PARTICIPANTS);
            if (stringArray == null || stringArray.length != 1) {
                return null;
            }
            if (remoteInputM21m != null) {
                remoteInput = new RemoteInput(remoteInputM21m.getResultKey(), remoteInputM21m.getLabel(), remoteInputM21m.getChoices(), remoteInputM21m.getAllowFreeFormInput(), Build.VERSION.SDK_INT >= 29 ? remoteInputM21m.getEditChoicesBeforeSending() : 0, remoteInputM21m.getExtras(), null);
            }
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m20m(it.next())));
                }
            }
        } else {
