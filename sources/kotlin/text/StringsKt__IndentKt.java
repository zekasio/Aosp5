...
class StringsKt__IndentKt extends StringsKt__AppendableKt {
    ...
    public static final String replaceIndentByMargin(String str, String newIndent, String marginPrefix) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList, new StringBuilder(length), (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 2) != 0 ? ", " : "\n", (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 4) != 0 ? "" : null, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 8) != 0 ? "" : null, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 16) != 0 ? -1 : 0, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 32) != 0 ? "..." : null, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 64) != 0 ? null : null)).toString();
    ...
    public static final String replaceIndent(String str, String newIndent) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList4, new StringBuilder(length), (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 2) != 0 ? ", " : "\n", (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 4) != 0 ? "" : null, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 8) != 0 ? "" : null, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 16) != 0 ? -1 : 0, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 32) != 0 ? "..." : null, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 64) != 0 ? null : null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return string;
    }
    ...
    private static final String reindent$StringsKt__IndentKt(List<String> list, int i, Function1<? super String, String> function1, Function1<? super String, String> function12) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList, new StringBuilder(i), (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 2) != 0 ? ", " : "\n", (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 4) != 0 ? "" : null, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 8) != 0 ? "" : null, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 16) != 0 ? -1 : 0, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 32) != 0 ? "..." : null, (MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES & 64) != 0 ? null : null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return string;
    }
}
