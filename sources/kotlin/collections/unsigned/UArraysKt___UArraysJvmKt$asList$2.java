...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return ULong.m504boximpl(m846getsVKNKU(i));
    }
    ...
    public int getSize() {
        return ULongArray.m570getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return ULongArray.m572isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m845containsVKZWuLQ(long element) {
        return ULongArray.m565containsVKZWuLQ(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-s-VKNKU, reason: not valid java name */
    public long m846getsVKNKU(int index) {
        return ULongArray.m569getsVKNKU(this.$this_asList, index);
    }
