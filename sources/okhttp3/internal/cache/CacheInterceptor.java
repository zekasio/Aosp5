...
public final class CacheInterceptor implements Interceptor {
    ...
    private static Headers combine(Headers headers, Headers headers2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((!"Warning".equalsIgnoreCase(strName) || !strValue.startsWith(TapjoyAuctionFlags.AUCTION_TYPE_FIRST_PRICE)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || headers2.get(strName) == null)) {
