...
public class C02023o {
    ...
    public C02023o(int i, int i2, int i3, Object obj) {
        this.A00 = i;
        this.A02 = i2;
        this.A01 = i3;
        this.A03 = obj;
    ...
    public final boolean equals(Object obj) {
        ...
        C02023o c02023o = (C02023o) obj;
        int i = this.A00;
        if (i != c02023o.A00) {
            return false;
        }
        if (i == 8 && Math.abs(this.A01 - this.A02) == 1 && this.A01 == c02023o.A02 && this.A02 == c02023o.A01) {
            return true;
        }
        if (this.A01 != c02023o.A01 || this.A02 != c02023o.A02) {
            return false;
        }
        Object obj2 = this.A03;
        if (obj2 != null) {
            if (!obj2.equals(c02023o.A03)) {
                return false;
            }
        } else {
            Object obj3 = c02023o.A03;
            if (A05[2].charAt(7) == 'q') {
                throw new RuntimeException();
            }
