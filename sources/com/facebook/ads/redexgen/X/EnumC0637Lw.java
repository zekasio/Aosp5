...
public enum EnumC0637Lw {
    ...
    EnumC0637Lw(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    public static EnumC0637Lw A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC0637Lw enumC0637Lw : values()) {
            if (enumC0637Lw.A01 == nativeComponentTag) {
                return enumC0637Lw;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0637Lw enumC0637LwA00 = A00(nativeComponentTag);
        if (view != null && enumC0637LwA00 != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC0637Lw enumC0637Lw) {
        if (view != null && enumC0637Lw != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC0637Lw);
        }
    }
