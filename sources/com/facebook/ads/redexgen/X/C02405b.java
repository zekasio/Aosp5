...
public final class C02405b implements RewardedVideoAdApi, Repairable {
    ...
    public C02405b(Context context, String str, com.facebook.ads.Ad ad) {
        this.A01 = ad;
    ...
    public final C02415c buildLoadAdConfig() {
        return new C02415c(this);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi, com.facebook.ads.FullScreenAd
    /* JADX INFO: renamed from: A03, reason: merged with bridge method [inline-methods] */
    public final C02425d buildShowAdConfig() {
        return new C02425d();
    }
    ...
    public final void loadAd(RewardedVideoAd.RewardedVideoLoadAdConfig rewardedVideoLoadAdConfig) {
        ((C02415c) rewardedVideoLoadAdConfig).A00();
    }
    ...
    public final void repair(Throwable th) {
        if (this.A02.A04 != null) {
            this.A02.A04.onError(this.A01, new AdError(2001, A00(31, 16, 5) + MA.A03(this.A02.A0B, th)));
        }
    }
    ...
    public final boolean show() {
        ...
        return A08(new C02425d().withAppOrientation(-1).build());
    }
