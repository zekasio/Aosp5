...
public final class MX implements Executor {
    ...
    public static void A04() {
        A04 = new byte[]{32, 50, 56, 47, 34, 125, 123, 124, 119, 102, 101, 125, 96, 121, 112, 74, 89, 70, 3, Ascii.RS, 3, 64, 117, 103, 127, 103, 52, 101, 97, 113, 97, 113, 52, 96, 123, 123, 52, 120, 123, 122, 115, 58, 70, 68, 79, 68, 83, 72, 66};
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (MX.class) {
            ...
            if (size == oldThreshold) {
                ...
                if (c0946XxA00 != null) {
                    c0946XxA00.A06().A8y(A00(42, 7, 27), C03298z.A1c, new AnonymousClass90(A00(21, 21, 46), A00(14, 7, 25) + i));
                }
            }
        }
