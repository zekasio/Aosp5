...
public final class GN implements InterfaceC1269eW {
    ...
    public final InterfaceC1271eY A02;
    ...
    public GN(View view, InterfaceC1271eY interfaceC1271eY) {
        this.A03 = new WeakReference<>(view);
        this.A02 = interfaceC1271eY;
    }
    ...
    private final void A02(List<Rect> list) {
        ...
        list2.add(rect);
        Iterator<InterfaceC1272eZ> it = this.A02.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC1269eW
