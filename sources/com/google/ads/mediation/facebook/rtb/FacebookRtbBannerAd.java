...
public class FacebookRtbBannerAd implements MediationBannerAd, AdListener {
    ...
    public void render() {
        ...
        try {
            ...
            AdError adError2 = new AdError(FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION, "Failed to create banner ad: " + e.getMessage(), "com.google.ads.mediation.facebook");
