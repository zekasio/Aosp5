...
public final class zzepc implements zzepn {
    ...
    zzepc(zzfuu zzfuuVar, Context context, zzbzg zzbzgVar) {
        this.zza = zzfuuVar;
        this.zzb = context;
        this.zzc = zzbzgVar;
    }
    ...
    final /* synthetic */ zzepd zzc() throws Exception {
        ...
        return new zzepd(zIsCallerInstantApp, zZzA, str, zZzB, applicationInfo == null ? 0 : applicationInfo.targetSdkVersion, DynamiteModule.getRemoteVersion(this.zzb, ModuleDescriptor.MODULE_ID), DynamiteModule.getLocalVersion(this.zzb, ModuleDescriptor.MODULE_ID));
    }
}
