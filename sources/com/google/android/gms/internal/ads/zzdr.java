...
public final class zzdr implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void zzb(int i) throws zzds {
        ...
        zzdt.zza(eGLDisplayEglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzdt.zza(EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        ...
        zzdt.zza(zEglChooseConfig && iArr2[0] > 0 && eGLConfigArr[0] != null, zzew.zzI("eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(zEglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]));
        ...
        zzdt.zza(eGLContextEglCreateContext != null, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzdt.zza(eGLSurfaceEglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdt.zza(EGL14.eglMakeCurrent(eGLDisplay, eGLSurfaceEglCreatePbufferSurface, eGLSurfaceEglCreatePbufferSurface, eGLContextEglCreateContext), "eglMakeCurrent failed");
