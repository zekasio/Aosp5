...
public final class zzdta {
    ...
    public static final void zzb(Context context, ViewGroup viewGroup, NativeAd nativeAd) {
        ...
        linearLayout.addView(zzc(context, resourcesZzd == null ? "Headline" : resourcesZzd.getString(R.string.native_headline), "headline_header_tag"));
        View viewZzd = zzd(context, zzfoj.zzc(nativeAd.getHeadline()), "headline_tag");
        nativeAdView.setHeadlineView(viewZzd);
        linearLayout.addView(viewZzd);
        linearLayout.addView(zzc(context, resourcesZzd == null ? "Body" : resourcesZzd.getString(R.string.native_body), "body_header_tag"));
        View viewZzd2 = zzd(context, zzfoj.zzc(nativeAd.getBody()), "body_tag");
        nativeAdView.setBodyView(viewZzd2);
        linearLayout.addView(viewZzd2);
        linearLayout.addView(zzc(context, resourcesZzd == null ? "Media View" : resourcesZzd.getString(R.string.native_media_view), "media_view_header_tag"));
