...
abstract class zzgqg {
    ...
    static zzgpy zzb(Class cls) {
        ...
        if (cls.equals(zzgpy.class)) {
            ...
            if (!cls.getPackage().equals(zzgqg.class.getPackage())) {
        ...
        try {
            try {
                try {
                    return (zzgpy) cls.cast(((zzgqg) Class.forName(str, true, classLoader).getConstructor(null).newInstance(null)).zza());
