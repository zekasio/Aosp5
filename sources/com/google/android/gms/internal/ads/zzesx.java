...
public final class zzesx implements zzgwy {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        boolean zBooleanValue = ((zzesl) this.zzb).zzb().booleanValue();
        boolean zBooleanValue2 = ((zzesm) this.zzc).zzb().booleanValue();
        zzbxy zzbxyVar = new zzbxy();
        zzfuu zzfuuVar = zzbzn.zza;
        zzgxg.zzb(zzfuuVar);
        return new zzesv(zzbyjVar, zBooleanValue, zBooleanValue2, zzbxyVar, zzfuuVar, ((zzesi) this.zzf).zza(), (ScheduledExecutorService) this.zzg.zzb(), null);
    }
}
