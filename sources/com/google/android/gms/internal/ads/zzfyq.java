...
final class zzfyq extends zzgct {
    ...
    zzfyq(zzfyr zzfyrVar, Class cls) {
        super(cls);
        this.zza = zzfyrVar;
    }
    ...
    public final /* bridge */ /* synthetic */ zzgrw zza(zzgrw zzgrwVar) throws GeneralSecurityException {
        ...
        zzgicVarZzc.zza(zzgpe.zzv(zzgoe.zza(((zzgig) zzgrwVar).zza())));
        zzgicVarZzc.zzb(0);
        return (zzgid) zzgicVarZzc.zzal();
    }
    ...
    public final Map zzc() throws GeneralSecurityException {
        ...
        map.put("AES128_GCM", zzfyr.zzg(16, 1));
        map.put("AES128_GCM_RAW", zzfyr.zzg(16, 3));
        map.put("AES256_GCM", zzfyr.zzg(32, 1));
        map.put("AES256_GCM_RAW", zzfyr.zzg(32, 3));
