...
public final class zzeui extends com.google.android.gms.ads.internal.client.zzbt implements com.google.android.gms.ads.internal.overlay.zzo, zzaus {
    ...
    private final synchronized void zzp(int i) {
        if (this.zzd.compareAndSet(false, true)) {
            ...
            if (this.zza != null) {
                ...
                if (this.zzi != -1) {
                    jElapsedRealtime = com.google.android.gms.ads.internal.zzt.zzB().elapsedRealtime() - this.zzi;
                }
    ...
    */
    ...
    public final synchronized void zzb() {
        ...
        this.zzj = zzcnsVar;
        zzcnsVar.zzd(iZza, new Runnable() { // from class: com.google.android.gms.internal.ads.zzeuf
