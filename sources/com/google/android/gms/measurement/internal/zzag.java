...
public final class zzag extends zzgk {
    ...
    */
    ...
    public final boolean zzs(String str, zzdt zzdtVar) {
        ...
        String strZza = this.zzb.zza(str, zzdtVar.zzb());
        return TextUtils.isEmpty(strZza) ? ((Boolean) zzdtVar.zza(null)).booleanValue() : ((Boolean) zzdtVar.zza(Boolean.valueOf(TapjoyAuctionFlags.AUCTION_TYPE_FIRST_PRICE.equals(strZza)))).booleanValue();
    }

    public final boolean zzt(String str) {
        return TapjoyAuctionFlags.AUCTION_TYPE_FIRST_PRICE.equals(this.zzb.zza(str, "gaia_collection_enabled"));
    }
    ...
    public final boolean zzw(String str) {
        return TapjoyAuctionFlags.AUCTION_TYPE_FIRST_PRICE.equals(this.zzb.zza(str, "measurement.event_sampling_enabled"));
    }
