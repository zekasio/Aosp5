...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(TJAdUnitConstants.String.WIDTH)) {
            arrayList.add(motionSpec.getAnimator(TJAdUnitConstants.String.WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(TJAdUnitConstants.String.HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(TJAdUnitConstants.String.HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
