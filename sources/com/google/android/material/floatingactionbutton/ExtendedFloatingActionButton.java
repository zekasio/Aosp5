...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, TJAdUnitConstants.String.WIDTH) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.4
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, TJAdUnitConstants.String.HEIGHT) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.5
        @Override // android.util.Property
        public void set(View view, Float f) {
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(TJAdUnitConstants.String.WIDTH)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(TJAdUnitConstants.String.WIDTH);
                propertyValues[0].setFloatValues(ExtendedFloatingActionButton.this.getWidth(), this.size.getWidth());
                currentMotionSpec.setPropertyValues(TJAdUnitConstants.String.WIDTH, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(TJAdUnitConstants.String.HEIGHT)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(TJAdUnitConstants.String.HEIGHT);
                propertyValues2[0].setFloatValues(ExtendedFloatingActionButton.this.getHeight(), this.size.getHeight());
                currentMotionSpec.setPropertyValues(TJAdUnitConstants.String.HEIGHT, propertyValues2);
            }
