...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    void setRippleColor(ColorStateList colorStateList) {
        if (SearchView$$ExternalSyntheticApiModelOutline0.m10m((Object) this.rippleDrawable)) {
            Okio$$ExternalSyntheticApiModelOutline0.m(this.rippleDrawable).setColor(RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        } else {
