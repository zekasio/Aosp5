...
class MaterialButtonHelper {
    ...
    void setRippleColor(ColorStateList colorStateList) {
        if (this.rippleColor != colorStateList) {
            ...
            if (z && SearchView$$ExternalSyntheticApiModelOutline0.m10m((Object) this.materialButton.getBackground())) {
                Okio$$ExternalSyntheticApiModelOutline0.m(this.materialButton.getBackground()).setColor(RippleUtils.sanitizeRippleDrawableColor(colorStateList));
            } else {
