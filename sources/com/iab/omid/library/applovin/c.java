...
class c {
    ...
    private static final Pattern f1562a = Pattern.compile("<(head)( [^>]*)?>", 2);
    ...
    static String a(String str, String str2) {
        ...
        if (!b(str, sb, b, str2, iArrA) && !a(str, sb, f1562a, str2, iArrA) && !b(str, sb, d, str2, iArrA) && !a(str, sb, c, str2, iArrA) && !b(str, sb, f, str2, iArrA) && !a(str, sb, e, str2, iArrA) && !a(str, sb, g, str2, iArrA)) {
            return str2 + str;
        }
        return sb.toString();
    }
