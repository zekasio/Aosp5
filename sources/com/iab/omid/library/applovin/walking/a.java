...
public class a {
    ...
    private final HashMap<View, String> f1585a = new HashMap<>();
    private final HashMap<View, C0092a> b = new HashMap<>();
    ...
    public static class C0092a {
        ...
        public C0092a(e eVar, String str) {
            this.f1586a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.applovin.adsession.a aVar) {
        ...
        C0092a c0092a = this.b.get(view);
        if (c0092a != null) {
            c0092a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0092a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String d(View view) {
        ...
        String str = this.f1585a.get(view);
        if (str != null) {
            this.f1585a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f1585a.put(viewC, adSessionId);
                            a(aVar);
